...
public class EchantillonController {
    ...
    @GetMapping("{medcinID}/AllIndexedEchantillons")
    public ResponseEntity<?> getAllIndexedEchantillons(@PathVariable("medcinID") String medcinID){
        Collection<EchantillonResponce> echantillonResponces = echantillonService.GetAllIndexedEchantillons(Long.parseLong(medcinID));
        return new ResponseEntity<Collection<EchantillonResponce>>(echantillonResponces, HttpStatus.OK);
    }
...
//    @GetMapping(value = "/image2/{image_name}")
...
//    }
    ...
    public ResponseEntity<Resource> getFile(@PathVariable String image_name) {
       Resource file = echantillonService.load(image_name);
