...
public class EchantillonService implements IEchantillonService {
   ...
   // private final Path root = Paths.get("C:/Users/hp/Desktop/Collection"); // Todo : Change root name

    private final Path root = Paths.get(System.getProperty("user.home")+"/RD-Data-Collection");
    ...
    public Collection<EchantillonResponce> GetAllIndexedEchantillons(Long medcin_id) {
        ...
        // List<Echantillon> echantillons = entityManager.createQuery(jpql, Echantillon.class).getResultList();
        Collection<Echantillon> echantillons = echantillonRepository.GetAllIndexedEchantillons(medcin_id);
